...
const BACKEND_URL = environment.apiUrl + "/duo/";
...
export class duoAdmin {
    ...
    getDuoPaidAds(adminData:string){
        return this.http.post<Array<{_id:string}>>(BACKEND_URL + "getDuoPaidAds",{adminData:adminData})
    }
    ...
    getDuoPagesStates(adminData:string){
    ...
    getDuoPagesStatesServer(adminData:string){
        return this.http.post<{
            registerTeamLeaderChampionshipType:boolean,
            registerMemberChampionshipType:boolean,
            registerFreeAdsType:boolean,
