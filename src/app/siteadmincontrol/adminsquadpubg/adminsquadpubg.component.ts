...
export class AdminsquadpubgComponent implements OnInit {
  ...
  groupsRamadan:Array<{round:number,groupNumber:number,groupPlayers:Array<{pubgIdTeamLeader:string , pubgIdFirstMember:string , pubgIdSecondMember:string , pubgIdThirdMember:string}>, date:string , time:number}> = [];
  ...
  addChampion(addChampionForm:NgForm){
    ...
    if(addChampionForm.valid){
      this.squadAdmin.addChampion(addChampionForm.value.startDate,addChampionForm.value.totalPlayers,addChampionForm.value.playerCountry,this.confirmRequest)
  ...
  endChampion(){
    this.disableButton = true;
    this.squadAdmin.deleteChampionShips(this.confirmRequest).subscribe((data1:{finish:boolean})=>{
      if(data1.finish == true){
        this.messageEndChampion = "championships delete successfully";
        this.squadAdmin.deleteHackersAndWinners(this.confirmRequest).subscribe((data2:{finish:boolean})=>{
          if(data2.finish == true){
            this.messageEndChampion += " -> hackers and winners delete successfully";
            this.squadAdmin.deleteRegisterFreeAds(this.confirmRequest).subscribe((data3:{finish:boolean})=>{
              if(data3.finish == true){
                this.messageEndChampion += " -> register free ads delete successfully";
                this.squadAdmin.deleteRegisterHackers(this.confirmRequest).subscribe((data4:{finish:boolean})=>{
                  if(data4.finish == true){
                    this.messageEndChampion += " -> register hackers delete successfully";
                    this.squadAdmin.deleteRegisterPlayers(this.confirmRequest).subscribe((data5:{finish:boolean})=>{
                      if(data5.finish == true){
                        this.messageEndChampion += " -> register players delete successfully";
                        this.squadAdmin.deleteSplitePlayers(this.confirmRequest).subscribe((data6:{finish:boolean})=>{
                          if(data6.finish == true){
                            this.messageEndChampion += " -> splite players delete successfully";
                            this.squadAdmin.deleteTempHackersAndWinners(this.confirmRequest).subscribe((data7:{finish:boolean})=>{
                              if(data7.finish == true){
                                this.messageEndChampion += " -> temp hackers and winners delete successfully";
                                this.squadAdmin.deleteTempSplitePlayers(this.confirmRequest).subscribe((data8:{finish:boolean})=>{
                                  if(data8.finish == true){
                                    this.messageEndChampion += " -> temp splite players delete successfully";
                                    this.squadAdmin.setAllServerRefFalse(this.confirmRequest).subscribe((data:{finish:boolean})=>{
                                      if(data.finish == true){
  ...
  deleteEmails(){
    this.disableButton = true;
    this.squadAdmin.deleteEmails(this.confirmRequest).subscribe((data:{finish:boolean})=>{
      if(data.finish == true){
  ...
  addCharityAds(){
    ...
    this.squadAdmin.getCharityAdsTable(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      adsData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      this.squadAdmin.addCharityAds(adsData,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getCharityAds(){
    this.disableButton = true;
    let adsData:Array<object> = null;
    this.squadAdmin.getCharityAds(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      adsData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  getCharityAdsServer(){
    ...
    this.squadAdmin.getCharityAdsServer(this.confirmRequest)
  ...
  deleteCharityAds(){
    this.disableButton = true;
    this.squadAdmin.deleteCharityAds(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getAddPaidAds(){
    ...
    this.squadAdmin.getPaidAds(this.confirmRequest)
    ...
    ,()=>{
      if(getAds.length != 0){
        ...
        this.squadAdmin.addPaidAds(addAds,this.confirmRequest)
        .subscribe((data:{message:string})=>{
  ...
  getNumberAddPaidAds(getNumberAddPaidAdsForm:NgForm){
    ...
    let getAds:Array<{_id:string}> = null;
    let addAds:Array<string> = [];
    this.squadAdmin.getNumberPaidAds(getNumberAddPaidAdsForm.value.number,this.confirmRequest)
    .subscribe((data:Array<{_id:string}>)=>{
      getAds = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  addPaidAd(addPaidAdForm:NgForm){
    ...
    this.squadAdmin.addPaidAd(paidAd,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getSquadPaidAds(){
    ...
    this.squadAdmin.getSquadPaidAds(this.confirmRequest)
    .subscribe((data:Array<{_id:string}>)=>{
      squadPaidAds = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  deletePaidAds(){
    this.disableButton = true;
    this.squadAdmin.deletePaidAds(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  deletePaidAd(deletePaidAdForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deletePaidAd(deletePaidAdForm.value.id,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getAllAddBlackList(){
    this.disableButton = true;
    this.squadAdmin.getAllAddBlackList(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getRandomAddBlackList(getRandomAddBlackListForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.getRandomAddBlackList(getRandomAddBlackListForm.value.numberPlayers,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getAllBlackList(){
    ...
    this.squadAdmin.getAllBlackList(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      AllBlackList = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  deleteAllBlackList(){
    this.disableButton = true;
    this.squadAdmin.deleteAllBlackList(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getPagesStates(){
    this.disableButton = true;
    this.squadAdmin.getSquadPagesStates(this.confirmRequest).subscribe((data:{exist:boolean,error:boolean,
  ...
  getPagesStatesServer(){
    this.disableButton = true;
    this.squadAdmin.getSquadPagesStatesServer(this.confirmRequest).subscribe((data:{
      registerTeamLeaderChampionshipType:boolean,
      registerMemberChampionshipType:boolean,
      registerFreeAdsType:boolean,
      registerReportHackerType:boolean,
  ...
  setTeamLeaderTypeTrue(){
    this.disableButton = true;
    this.squadAdmin.setTeamLeaderTypeTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setMemberTypeTrue(){
    this.disableButton = true;
    this.squadAdmin.setMemberTypeTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setFreeAdsTypeTrue(){
    this.disableButton = true;
    this.squadAdmin.setFreeAdsTypeTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setReportHackerTypeTrue(){
    this.disableButton = true;
    this.squadAdmin.setReportHackerTypeTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setAppearHackerAndWinnersTrue(){
    this.disableButton = true;
    this.squadAdmin.setAppearHackerAndWinnersTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setSplitPlayersTypeTrue(){
    this.disableButton = true;
    this.squadAdmin.setSplitPlayersTypeTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setExistPaidAdsTrue(){
    this.disableButton = true;
    this.squadAdmin.setExistPaidAdsTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setShowAdsWillAppearTrue(){
    this.disableButton = true;
    this.squadAdmin.setShowAdsWillAppearTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setPhonesAcceptPlayersTrue(){
    this.disableButton = true;
    this.squadAdmin.setPhonesAcceptPlayersTrue(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setTeamLeaderTypeFalse(){
    this.disableButton = true;
    this.squadAdmin.setTeamLeaderTypeFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setMemberTypeFalse(){
    this.disableButton = true;
    this.squadAdmin.setMemberTypeFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setFreeAdsTypeFalse(){
    this.disableButton = true;
    this.squadAdmin.setFreeAdsTypeFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setReportHackerTypeFalse(){
    this.disableButton = true;
    this.squadAdmin.setReportHackerTypeFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setAppearHackerAndWinnersFalse(){
    this.disableButton = true;
    this.squadAdmin.setAppearHackerAndWinnersFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setSplitPlayersTypeFalse(){
    this.disableButton = true;
    this.squadAdmin.setSplitPlayersTypeFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setExistPaidAdsFalse(){
    this.disableButton = true;
    this.squadAdmin.setExistPaidAdsFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setShowAdsWillAppearFalse(){
    this.disableButton = true;
    this.squadAdmin.setShowAdsWillAppearFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  setPhonesAcceptPlayersFalse(){
    this.disableButton = true;
    this.squadAdmin.setPhonesAcceptPlayersFalse(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getAddPagesStates(){
    this.disableButton = true;
    this.squadAdmin.getAddPagesStates(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getRegisterAds(){
    ...
    this.squadAdmin.getRegisterAds(this.confirmRequest)
  ...
  addAdsWillAppear(freeAds:NgForm){
    ...
    this.squadAdmin.getAdsWillAppear(freeAds.value.numberAds,this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      addAdsWillAppear = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      if(addAdsWillAppear.length != 0){
        this.squadAdmin.addAdsWillAppear(addAdsWillAppear,this.confirmRequest)
        .subscribe((data:{message:string})=>{
  ...
  addFreeAd(addFreeAdForm:NgForm){
    ...
    this.squadAdmin.addFreeAd(videoId ,addFreeAdForm.value.email , addFreeAdForm.value.adCountry,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getRealAdsWillAppear(){
    this.disableButton = true;
    let adsData:Array<object> = null;
    this.squadAdmin.getRealAdsWillAppear(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      adsData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  getRealAdsWillAppearServer(){
    ...
    let adsData:{ads:object} = null;
    let countAdsData:number = 0;
    this.squadAdmin.getRealAdsWillAppearServer(this.confirmRequest)
    .subscribe((data:{ads:object})=>{
      adsData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  deleteAdsWillAppear(){
    this.disableButton = true;
    this.squadAdmin.deleteAdsWillAppear(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  deleteFreeAd(deleteFreeAdForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deleteFreeAd(deleteFreeAdForm.value.id,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  adsFromDatabaseToServer(){
    this.disableButton = true;
    this.squadAdmin.adsFromDatabaseToServer(this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  deleteAllRegisterFree(){
    this.disableButton = true;
    this.squadAdmin.deleteRegisterFreeAds(this.confirmRequest).subscribe((data:{finish:boolean})=>{
      if(data.finish == true){
    ...
    let data:Array<object> = [
      {
        ...
        emailFirstMember:"playtogain2020@gmail.com",
        pubgIdFirstMember:addPlayerForm.value.firstMemberPubgId ,
        displayedAdFirstMember:"adminData",
        acceptFirstPlayer:true,
        emailSecondMember:"playtogain2020@gmail.com",
        pubgIdSecondMember:addPlayerForm.value.secondMemberPubgId ,
        displayedAdSecondMember:"adminData",
        acceptSecondPlayer:true,
        emailThirdMember:"playtogain2020@gmail.com",
        pubgIdThirdMember:addPlayerForm.value.thirdMemberPubgId ,
        displayedAdThirdMember:"adminData",
        acceptThirdPlayer:true,
      }
    ]
    this.squadAdmin.addPlayer(data,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  deletePlayer(deletePlayerForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deletePlayer(deletePlayerForm.value.pubgId,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getPlayersAndCountDays(getPlayersAndCountDaysForm:NgForm){
    ...
    this.squadAdmin.getIdsPubg(this.confirmRequest).subscribe(data=>{
  ...
  getCountWinners(getCountWinnersForm:NgForm){
    this.disableButton = true;
    let getPubgIdsArray:Array<object> = [];
    this.squadAdmin.getLastWinnersRound(this.confirmRequest).subscribe(data=>{
      getPubgIdsArray = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      if(getPubgIdsArray.length != 0){
  ...
  autoSplitPlayersWinners(splitPlayersAutoWinners:NgForm){
    ...
    this.squadAdmin.getSplitPlayer(this.confirmRequest).subscribe(data=>{
      splitPlayers = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  continueAutoSplitPlayersWinners(splitPlayersAutoWinners:NgForm){
    this.squadAdmin.deleteSplitePlayers(this.confirmRequest).subscribe((data1:{finish:boolean})=>{
      if(data1.finish == true){
  ...
  addSplitPlayerIdPubg(idPubgForm:NgForm){
    this.disableButton = true;
    this.PubgIdsGroup.push({pubgIdTeamLeader:idPubgForm.value.pubgIdTeamLeader , pubgIdFirstMember:idPubgForm.value.firstMemberPubgId , pubgIdSecondMember:idPubgForm.value.secondMemberPubgId , pubgIdThirdMember:idPubgForm.value.thirdMemberPubgId});
    this.disableButton = false;
  }
  ...
  addSubSplitPlayers(data:Array<object> , number:number , detectVariable:string){
    if(data.length != 0){
      ...
      setTimeout(function () {
        ...
        _this.squadAdmin.addSplitPlayers(subData,_this.confirmRequest).subscribe((data1:{finish:boolean})=>{
          if(data1.finish == true){
  ...
  addSubTempSplitPlayers(data:Array<object> , number:number , detectPlaceReturn:string , splitPlayersAutoWinners:NgForm){
    if(data.length != 0){
      ...
      setTimeout(function () {
        let subData = data.splice(0,50);
        _this.squadAdmin.addTempSplitPlayer(subData,_this.confirmRequest).subscribe((data1:{finish:boolean})=>{
          if(data1.finish == true){
  ...
  getSplitPlayer(){
    ...
    this.squadAdmin.getSplitPlayer(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
  ...
  getSplitPlayerDate(getSplitPlayersDateForm:NgForm){
    this.disableButton = true;
    let splitPlayersData:Array<object> = null;
    this.squadAdmin.getSplitPlayerDate(getSplitPlayersDateForm.value.date,this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      splitPlayersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  getAddSplitPlayers(){
    this.disableButton = true;
    let splitPlayersData:Array<object> = null;
    this.squadAdmin.getLastSplitPlayersTempRound(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      splitPlayersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      if(splitPlayersData.length != 0){
        ...
        this.squadAdmin.deleteSplitePlayers(this.confirmRequest).subscribe((data:{finish:boolean})=>{
          if(data.finish == true){
  ...
  contuneGetAddSplitPlayers(){
    this.squadAdmin.deleteTempSplitPlayersLR(this.confirmRequest).subscribe((data2:{finish:boolean})=>{
      if(data2.finish == true){
  ...
  deleteRegisterPlayers(){
    this.disableButton = true;
    this.squadAdmin.deleteRegisterPlayers(this.confirmRequest).subscribe((data:{finish:boolean})=>{
      if(data.finish == true){
  ...
  getRegisterHackers(){
    ...
    this.squadAdmin.getRegisterHackers(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
  ...
  getDataDebendId(hackerEmail:NgForm){
    this.disableButton = true;
    this.squadAdmin.getDataDebendId(hackerEmail.value.hackerPubgId,this.confirmRequest).subscribe((data:Array<object>)=>{
      console.log(data);
      this.disableButton = false;
    });
  }
  pushHacker(hackerData:NgForm){
    this.disableButton = true;
    this.hackersDataArray.push({round:hackerData.value.round,pubgIdTeamLeader:hackerData.value.hackerPubgId ,pubgIdFirstMember:hackerData.value.hackerPubgId ,pubgIdSecondMember:hackerData.value.hackerPubgId ,pubgIdThirdMember:hackerData.value.hackerPubgId , email:hackerData.value.hackerEmail , isWinner :false});
    this.disableButton = false;
  }
  popHacker(){
    this.disableButton = true;
  ...
  addHackers(){
    ...
    {
      this.squadAdmin.addHackers(this.hackersDataArray,this.confirmRequest).subscribe((data:{message:string})=>{
    ...
    let hackerData = [
      {
        ...
        pubgIdFirstMember:sendOneHackerDataForm.value.hackerPubgId ,
        pubgIdSecondMember:sendOneHackerDataForm.value.hackerPubgId ,
        pubgIdThirdMember:sendOneHackerDataForm.value.hackerPubgId,
        email:sendOneHackerDataForm.value.hackerEmail,
        isWinner:false
      }
    ]
    this.squadAdmin.addHackers(hackerData,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getLastHackersRound(){
    ...
    this.squadAdmin.getLastHackersRound(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      hackersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  deleteReportHacker(deleteReportHackerForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deleteReportHacker(deleteReportHackerForm.value.id,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  pushWinnerPubg(winnersData:NgForm){
    this.disableButton = true;
    this.winnersData.push({round:winnersData.value.round,pubgIdTeamLeader:winnersData.value.winnerPubgIdTeamLeader ,pubgIdFirstMember:winnersData.value.firstMemberPubgId ,pubgIdSecondMember:winnersData.value.secondMemberPubgId ,pubgIdThirdMember:winnersData.value.thirdMemberPubgId , email:"playtogain2020@gmail.com" , isWinner :true});
    this.disableButton = false;
  }
  popWinnerPubg(){
    this.disableButton = true;
  ...
  addWinners(){
    ...
    {
      this.squadAdmin.addWinners(this.winnersData,this.confirmRequest).subscribe((data:{message:string})=>{
    ...
    let winnerData =[
      {
        ...
        pubgIdFirstMember:sendOneWinnerDataForm.value.firstMemberPubgId ,
        pubgIdSecondMember:sendOneWinnerDataForm.value.secondMemberPubgId ,
        pubgIdThirdMember:sendOneWinnerDataForm.value.thirdMemberPubgId,
        email:"playtogain2020@gmail.com",
        isWinner:true
      }
    ]
    this.squadAdmin.addWinners(winnerData,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getLastWinnersRound(){
    ...
    this.squadAdmin.getLastWinnersRound(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      winnersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  deleteWinner(deleteWinnerForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deleteWinner(deleteWinnerForm.value.id,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  addDeleteHackersAndWinners(){
    ...
    this.squadAdmin.getLastHackersAndWinnersRound(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
  ...
  continueAddDeleteHackersAndWinners(){
    this.squadAdmin.deleteHackersAndWinners(this.confirmRequest).subscribe((data:{finish:boolean})=>{
      if(data.finish == true){
  ...
  getAddHackersAndWinners(){
    this.disableButton = true;
    let HackersAndWinnersData:Array<object> = null;
    this.squadAdmin.getLastHackersAndWinnersTempRound(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      HackersAndWinnersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  continueGetAddHackersAndWinners(){
    this.squadAdmin.deleteTempHackersAndWinnersLR(this.confirmRequest).subscribe((data2:{finish:boolean})=>{
      if(data2.finish == true){
  ...
  addSubHackersAndWinners(data:Array<object> , number:number){
    if(data.length != 0){
      ...
      setTimeout(function () {
        ...
        _this.squadAdmin.addHackersAndWinners(subData,_this.confirmRequest).subscribe((data1:{finish:boolean})=>{
          if(data1.finish == true){
  ...
  addSubTempHackersAndWinners(data:Array<object> , number:number){
    if(data.length != 0){
      ...
      setTimeout(function () {
        let subData = data.splice(0,5000);
        _this.squadAdmin.addTempHackersAndWinners(subData,_this.confirmRequest).subscribe((data1:{finish:boolean})=>{
          if(data1.finish == true){
  ...
  getAddBlackList(){
    this.disableButton = true;
    let hackersData:Array<{pubgIdTeamLeader:string,pubgIdFirstMember:string,pubgIdSecondMember:string,pubgIdThirdMember:string,email:string}> = null;
    this.squadAdmin.getAllTempHackers(this.confirmRequest)
    .subscribe((data:Array<{pubgIdTeamLeader:string,pubgIdFirstMember:string,pubgIdSecondMember:string,pubgIdThirdMember:string,email:string}>)=>{
      hackersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      let subHackersData:Array<{pubgIdTeamLeader:string,pubgIdFirstMember:string,pubgIdSecondMember:string,pubgIdThirdMember:string,email:string}> = null;
      this.messageGetAddBlackList = "data get from hacker temp table successfully";
      this.squadAdmin.getAllHackers(this.confirmRequest)
      .subscribe((data1:Array<{pubgIdTeamLeader:string,pubgIdFirstMember:string,pubgIdSecondMember:string,pubgIdThirdMember:string,email:string}>)=>{
  ...
  addSubBlackList(data:Array<object> , number:number){
    if(data.length != 0){
      ...
      setTimeout(function () {
        let subData = data.splice(0,5000);
        _this.squadAdmin.addSubBlackList(subData,_this.confirmRequest).subscribe((messageData:{message:string})=>{
  ...
  addPhonesNumbers(){
    ...
    {
      this.squadAdmin.addPhonesNumbers(this.phonesNumbersData,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  addPhoneNumber(addPhoneNumberForm:NgForm){
    ...
    this.squadAdmin.addPhonesNumbers(phoneData,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  getAllPhonesNumbers(){
    ...
    this.squadAdmin.getAllPhonesNumbers(this.confirmRequest)
    .subscribe((data:Array<object>)=>{
  ...
  getPhoneNumberPhones(getPhoneNumberPhonesForm:NgForm){
    ...
    this.squadAdmin.getPhoneNumberPhones(getPhoneNumberPhonesForm.value.PhoneNumber,this.confirmRequest)
  ...
  getPhoneNumberRegister(getPhoneNumberRegisterForm:NgForm){
    ...
    this.squadAdmin.getPhoneNumberRegister(getPhoneNumberRegisterForm.value.PhoneNumber,this.confirmRequest)
  ...
  getPlayersNotPhones(){
    this.disableButton = true;
    let playersData:Array<{phoneTeamLeader:string , phoneFirstMember:string ,phoneSecondMember:string , phoneThirdMember:string}> = [];
    this.squadAdmin.getRegisterPlayersData(this.confirmRequest)
    .subscribe((data:Array<{phoneTeamLeader:string , phoneFirstMember:string ,phoneSecondMember:string , phoneThirdMember:string}>)=>{
      playersData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      ...
      ,()=>{
        ...
        let playersNotPayFirstMember:Array<object> = [];
        let playersNotPaySecondMember:Array<object> = [];
        let playersNotPayThirdMember:Array<object> = [];
        ...
        for (let index = 0; index < playersData.length; index++) {
          ...
          for (let index1 = 0; index1 < phonesData.length; index1++) {
            const element1 = phonesData[index1];
            if(element.phoneFirstMember == element1.phone){
              flag = true;
              break;
            }
          }
          if(flag == false){
            playersNotPayFirstMember.push(element);
          }
          flag = false;
        }
        for (let index = 0; index < playersData.length; index++) {
          ...
          for (let index1 = 0; index1 < phonesData.length; index1++) {
            const element1 = phonesData[index1];
            if(element.phoneSecondMember == element1.phone){
              flag = true;
              break;
            }
          }
          if(flag == false){
            playersNotPaySecondMember.push(element);
          }
          flag = false;
        }
        for (let index = 0; index < playersData.length; index++) {
          ...
          for (let index1 = 0; index1 < phonesData.length; index1++) {
            const element1 = phonesData[index1];
            if(element.phoneThirdMember == element1.phone){
              flag = true;
              break;
            }
          }
          if(flag == false){
            playersNotPayThirdMember.push(element);
          }
          flag = false;
        }
        this.numberGetPlayersNotPhones = playersNotPayTeamLeader.length + playersNotPayFirstMember.length + playersNotPaySecondMember.length + playersNotPayThirdMember.length;
        console.log("------team leader not pay ------");
        console.log(playersNotPayTeamLeader);
        console.log("--------------------------------------");
        console.log("------first member not pay ------");
        console.log(playersNotPayFirstMember);
        console.log("--------------------------------------");
        console.log("------second member not pay ------");
        console.log(playersNotPaySecondMember);
        console.log("--------------------------------------");
        console.log("------third member not pay ------");
        console.log(playersNotPayThirdMember);
        this.disableButton = false;
      });
    });
  }
  deletePhoneNumber(deletePhoneNumberForm:NgForm){
    this.disableButton = true;
    this.squadAdmin.deletePhoneNumber(deletePhoneNumberForm.value.PhoneNumber,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  deleteAllPhonesNumbers(){
    this.disableButton = true;
    this.squadAdmin.deleteAllPhonesNumbers(this.confirmRequest).subscribe((data:{finish:boolean})=>{
      if(data.finish == true){
  ...
  getSpecificRamadan(getSpecificRamadanForm:NgForm){
    ...
    this.squadAdmin.getSpecificRamadan(date , time , this.confirmRequest)
    .subscribe((data:Array<{round:number,groupNumber:number,groupPlayers:Array<{pubgIdTeamLeader:string , pubgIdFirstMember:string , pubgIdSecondMember:string , pubgIdThirdMember:string}>, date:string , time:number}>)=>{
    ...
    if(this.groupsRamadan.length != 0)
    {
      for (let index = 0; index < this.groupsRamadan.length; index++) {
        ...
        for (let subIndex = 0; subIndex < this.groupsRamadan[index].groupPlayers.length; subIndex++) {
          ...
          if(element.pubgIdTeamLeader == deletePlayerGroupRamadanForm.value.deletePubgId 
            || element.pubgIdFirstMember == deletePlayerGroupRamadanForm.value.deletePubgId
            || element.pubgIdSecondMember == deletePlayerGroupRamadanForm.value.deletePubgId
            || element.pubgIdThirdMember == deletePlayerGroupRamadanForm.value.deletePubgId)
          {
  ...
  searchPlayerGroupRamadan(searchPlayerGroupRamadanForm:NgForm){
    ...
    if(this.groupsRamadan.length != 0)
    {
      for (let index = 0; index < this.groupsRamadan.length; index++) {
        ...
        for (let subIndex = 0; subIndex < this.groupsRamadan[index].groupPlayers.length; subIndex++) {
          const element = this.groupsRamadan[index].groupPlayers[subIndex];
          if(element.pubgIdTeamLeader == searchPlayerGroupRamadanForm.value.deletePubgId 
            || element.pubgIdFirstMember == searchPlayerGroupRamadanForm.value.deletePubgId
            || element.pubgIdSecondMember == searchPlayerGroupRamadanForm.value.deletePubgId
            || element.pubgIdThirdMember == searchPlayerGroupRamadanForm.value.deletePubgId)
          {
            indexPlayer = subIndex;
            break;
          }
  ...
  addSpecificRamadan(addSpecificRamadanForm:NgForm){
    ...
    if(this.groupsRamadan.length != 0){
      ...
      this.squadAdmin.addSpecificRamadan(this.groupsRamadan , this.confirmRequest)
  ...
  deleteSpecificRamadan(deleteSpecificRamadanForm:NgForm){
    ...
    this.squadAdmin.deleteSpecificRamadan(date , time , this.confirmRequest)
    .subscribe((data:string)=>{
  ...
  getTimeSpecificRamadan(getTimeSpecificRamadanForm:NgForm){
    ...
    this.squadAdmin.getTimeSpecificRamadan(time , this.confirmRequest)
    .subscribe((data:Array<object>)=>{
      groupsData = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
  ...
  getAllPlayersData(){
    this.disableButton = true;
    this.squadAdmin.getAllPlayersData(this.confirmRequest)
  ...
  getAddTotalPlayers(){
    this.disableButton = true;
    let getPubgIdsArray:Array<object> = [];
    this.squadAdmin.getIdsPubgRegister(this.confirmRequest).subscribe(data=>{
      getPubgIdsArray = data;
    },error=>this.dialog.open(ErrorComponent)
    ,()=>{
      this.squadAdmin.addTotalPlayersServer(getPubgIdsArray.length,this.confirmRequest).subscribe((data:{message:string})=>{
  ...
  /*test*/
  addPlayersTest(){
    this.squadAdmin.addPlayersTest(this.confirmRequest).subscribe((data:{message:string})=>{
