...
export class squadAdmin {
    ...
    getSquadPaidAds(adminData:string){
        return this.http.post<Array<{_id:string}>>(BACKEND_URL + "getSquadPaidAds",{adminData:adminData})
    }
    ...
    getSquadPagesStates(adminData:string){
        return this.http.post<{
            exist:boolean,error:boolean,
    ...
    getSquadPagesStatesServer(adminData:string){
        return this.http.post<{
            registerTeamLeaderChampionshipType:boolean,
            registerMemberChampionshipType:boolean,
            registerFreeAdsType:boolean,
    ...
    setTeamLeaderTypeTrue(adminData:string){
        return this.http.post<{message:string}>(BACKEND_URL + "setTeamLeaderTypeTrue",{adminData:adminData});
    }
    setMemberTypeTrue(adminData:string){
        return this.http.post<{message:string}>(BACKEND_URL + "setMemberTypeTrue",{adminData:adminData});
    }
    ...
    setTeamLeaderTypeFalse(adminData:string){
        return this.http.post<{message:string}>(BACKEND_URL + "setTeamLeaderTypeFalse",{adminData:adminData});
    }
    setMemberTypeFalse(adminData:string){
        return this.http.post<{message:string}>(BACKEND_URL + "setMemberTypeFalse",{adminData:adminData});
    }
    ...
    addPlayer(data:Array<object>,adminData:string){
        return this.http.post<{message:string}>(BACKEND_URL + "addPlayer" , {data:data,adminData:adminData})
    }
    ...
    getIdsPubg(adminData:string){
        return this.http.post<Array<object>>(BACKEND_URL + "getPubgIds",{adminData:adminData});
    }
    getIdsPubgRegister(adminData:string){
        return this.http.post<Array<object>>(BACKEND_URL + "getIdsPubgRegister",{adminData:adminData});
    }
    ...
    getLastWinnersRound(adminData:string){
        return this.http.post<Array<object>>(BACKEND_URL + "getLastWinnersRound",{adminData:adminData});
    }
    ...
    getDataDebendId(idPubg:string,adminData:string){
        return this.http.post<Array<object>>(BACKEND_URL + "getDataDebendId" , {idPubg:idPubg,adminData:adminData});
    }
    ...
    getPhoneNumberRegister(PhoneNumber:string,adminData:string){
        return this.http.post<{message:string , player:object}>(BACKEND_URL + "getPhoneNumberRegister",{PhoneNumber:PhoneNumber,adminData:adminData});
    }
    getRegisterPlayersData(adminData:string){
        return this.http.post<Array<object>>(BACKEND_URL + "getRegisterPlayersData",{adminData:adminData});
    }
